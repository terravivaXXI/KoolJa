...
* Oct 31st - Nov 2nd, 2018:  **Introduction to RNA-seq using High-Performance Computing**. *Application process will open in late summer*.
* Nov 14th - 16th, 2018: **Introduction to R and Differential Gene Expression (DGE) analysis for RNA-seq**. *Application process will open in late summer*.
