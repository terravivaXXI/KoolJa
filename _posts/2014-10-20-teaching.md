...
* **October-December: *In-depth NGS data analysis course (RNA-Seq only)***
	...
	** *[Application Process is Now Closed!](http://tinyurl.com/ngs-course-fall-2016)* **
...
* **October 20th: *Introduction to Differential Gene Expression analysis***
	...
	**Prerequisite: *Introduction to R*** (You are eligibile to attend only if you have taken an R course with us prior to this workshop.)
	...
	This 1-day workshop is designed to teach researchers the basic concepts for performing differential gene expression analysis using tools in R. This course will only be available to participants of the R workshop offered in September.
